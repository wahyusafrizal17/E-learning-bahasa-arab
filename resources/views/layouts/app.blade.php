...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <meta name="description" content="Belajar Bahasa Arab">
        <meta name="keywords" content="Belajar Bahasa Arab">
    ...
    <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item {!!(Request::is('kelas*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('kelas.index') }}">
                            ...
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Data Kelas</span>
                        </a>
                    </li>
        ...
        <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0">
                <span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; {{date('Y')}}</span>
            </p>
        </footer>
